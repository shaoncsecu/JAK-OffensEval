...
""" Finetuning the library models for sequence classification on OffensEval (Bert, XLM, XLNet, RoBERTa, Albert, XLM-RoBERTa)."""
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    with open(args.output_dir + '/dev_preds.txt', 'w') as outfile:
